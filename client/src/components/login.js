          ...
          <ul className="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li className="nav-item d-none d-lg-block ml-lg-4">
              <a href="register" className="btn btn-neutral btn-icon">
                ...
                <Link className="nav-link-inner--text" to="/register">Rejestracja</Link>
              </a>
            </li>
          </ul>
        </div>
          ...
          <div className="col-lg-5">
              ...
              <div className="card-body px-lg-5 py-lg-5">
                ...
                <form>
                  ...
                  <div className="text-center">
                    <button type="button" className="btn btn-primary my-4" onClick={loginUser}>Zaloguj</button>
                  </div>
                </form>
              </div>
            </div>
            <div className="row mt-3">
              ...
              <div className="col-6 text-right">
                <Link className="text-light" to="/register"><small>Zarejestruj się!</small></Link>
              </div>
            </div>
          </div>
        </div>
